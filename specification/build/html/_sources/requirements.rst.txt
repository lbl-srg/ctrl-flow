...
* The application can be embedded in third party softwares. The primary target is `OpenStudio® <https://www.openstudio.net>`_ (OS) for which the only additional requirement is to build down the UI to a single page HTML document.
